...
class Live_Streaming(object):
    ...
    def act(self, action_1, action_2, log_file=None, massive=False):
        ...
        while True:
            ...
            state[9, -1] = action_2                                         # playing speed, 0.75 to 1.25
    ...
    def save_bw_trace(self, cooked_name, cdf_path=None):
        tp_record = self.player.get_test_tp()
        cdf_path.write('\t'.join(str(tp) for tp in tp_record))
        cdf_path.write('\n')
